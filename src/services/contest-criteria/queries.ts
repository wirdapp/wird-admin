...
export function useDeleteSection() {
  ...
  return useMutation({
    mutationFn: (id: string) =>
      ContestCriteriaService.deleteSection({ id, contestId }),
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: contestCriteriaKeys.sectionsList(contestId),
      });
...
export function useCriteriaById(
  ...
  return useQuery({
    ...
    queryFn: () =>
      ContestCriteriaService.getById({ id: id!, contestId: cid }),
    enabled: !!cid && !!id,
    ...options,
  });
}
...
export function useDeleteCriteria() {
  ...
  return useMutation({
    mutationFn: (id: string) =>
      ContestCriteriaService.deleteCriteria({ id, contestId }),
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: contestCriteriaKeys.criteriaList(contestId),
      });
