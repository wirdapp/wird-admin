...
import type { ContestRaw, Contest, ContestCreateData, ContestUpdateData } from '../../types';
...
export function useCreateContest() {
  ...
  return useMutation({
    mutationFn: (formData: ContestCreateData) =>
      ContestsService.createContest(formData),
    onSuccess: () => {
