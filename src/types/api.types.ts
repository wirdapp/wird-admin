...
export function isMultiCheckboxCriterion(criterion: ContestCriterion): criterion is MultiCheckboxCriterion {
...
export function isMultiCheckboxPointRecord(record: PointRecord): record is MultiCheckboxPointRecord {
