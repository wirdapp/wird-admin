...
const sheetVariants = cva(
	"fixed z-50 gap-4 bg-background p-6 transition ease-in-out data-[closed]:duration-300 data-[open]:duration-500 data-[open]:animate-in data-[closed]:animate-out",
	{
		variants: {
			side: {
