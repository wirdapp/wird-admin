	...
	return (
		<>
			<StyledResultsOverviewHeader>
				...
				<StyledSubmissionCountCell>{t("no-of-submissions")}</StyledSubmissionCountCell>
				<StyledTop3Cell>{t("top-3")}</StyledTop3Cell>
			</StyledResultsOverviewHeader>

			<StyledResultsOverviewListWrapper>
				<div className={cx("overflow-indicator top", { visible: topOverflow })} />
				<div
								...
								<StyledDayCell>
									...
									<div>
										<div className="day-index">
											{t("day")} {resultIndex + 1}{" "}
											{isToday && <span className="today-indicator">({t("today")})</span>}
										</div>
										<div className="day-date">{dayjs(result.date).format("DD MMM YYYY")}</div>
									</div>
								</StyledDayCell>
								<StyledSubmissionCountCell>
