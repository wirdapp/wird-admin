...
import { App, Avatar, Spin, Tooltip, Upload, type UploadProps } from "antd";
...
export const ProfilePictureUploader: React.FC<ProfilePictureUploaderProps> = ({ onSubmit }) => {
	...
	return (
        ...
        `}
			>
				{imageUrl ? (
					<Avatar src={imageUrl} alt="avatar" size={100} style={{ backgroundColor: "transparent" }}>
						<ArrowUpTrayIcon style={{ color: colors.darkGrey, width: 20, height: 20 }} />
					</Avatar>
				) : (
					uploadButton
				)}
